...
app.get("/livvie", function(req, res) { res.status(200).sendFile(__dirname + "/public/html/livvy.html") })
...
app.get("/giselle", function(req, res) { res.status(200).sendFile(__dirname + "/public/html/giselle.html") })
...
app.get("/ash", function(req, res) { res.status(200).sendFile(__dirname + "/public/html/ash.html") })
